...
urlpatterns = [
    ...
    path('localitati-judet/<slug:slug>/', CityListByCountyAV.as_view(), name='city-list-by-county'), 
    path('oras/<slug:city_slug>/judet/<slug:county_slug>/', CityDetailAV.as_view(), name='city-detail'),  
    path('cartiere-oras/<slug:city_slug>/judet/<slug:county_slug>/', NeighborhoodListByCityAV.as_view()),
    path('cartier/<slug:neighborhood_slug>/oras/<slug:city_slug>/judet/<slug:county_slug>/', NeighborhoodDetailAV.as_view(), name='neighborhood-detail'),          
    ...
    path('promote-listing/', PromoteListingView.as_view(), name='promote-listing'),  
    ...
    path('listings/promoted/', promotedListingWidgetAPIView.as_view(), name='promoted_listings'),         
